...
The [quantitative training guide](https://ahurford.github.io/quant-guide-all-courses/) has been written to teach MUN biology students R coding to build a foundation for more advanced quantitative analysis of data in upper year Biology courses. We anticipate that this guide will also be a useful resource manual that you will refer back to as you use R in your future courses.
...
2.  Follow the steps in [R and RStudio](https://ahurford.github.io/quant-guide-all-courses/install.html) to install R and RStudio. If you are having issues with installing the software, check the [Frequently Asked Questions](%5Bhttps://ahurford.github.io/quant-guide-all-courses/faq.html).
...
-   When you encounter **TRY IT!** or Courier font text in a grey box, this is an example of code that we want you to try in RStudio. Note that you should type the code exactly as it is written. NOTE: We will sometimes give you only part of the code, or we will give code that has a deliberate mistake in it. This is not to frustrate you - rather it is a way for you to start to develop your problem solving skills. Read the text before and after the example code carefully for clues as to what you should do.

-   When you encounter EXERCISE or **HAND IN** this is a question that your instructor may ask you to complete and hand in.
...
4.  Before starting this exercise, we advise you to work through [Introduction to R](https://ahurford.github.io/quant-guide-all-courses/rintro.html) from the [quantitative training guide](https://ahurford.github.io/quant-guide-all-courses/). If you have previous experience with R from another course, you may skip this step, but if you find yourself getting stuck, the first thing you should do is come back to this step. 

5.  Proceed through the sections as assigned by your instructor (this will vary semester by semester with different due dates).

Expect to get stuck. This is normal when learning a new skill. Everyone who uses R, including professionals who have used it for years, get error messages and have bugs in their code. You might look for help in [Getting help](https://ahurford.github.io/quant-guide-all-courses/help.html) or ask for help from an instructor as specified in section \@ref(howtoask).

Once you've finished the first-year R Assignment, don't forget that you have this resource. Whenever you practice using R you will get better at it. If you haven't used it for a while, your skills get rusty, but by reviewing the relevant sections of the [quantitative training guide](https://ahurford.github.io/quant-guide-all-courses/) you will quickly be able to catch up. Before you know it, you will be confidently doing quantitative work in R, which will increase your knowledge, enhance your ability to do advanced biology work, and give you a marketable skill in the work world.
