...
```{r}
langdon_data <- read.csv("Langdon_et-al_2000_dataset.csv")
...
library(knitr)
falik_data <- read.csv("Falik_et-al_2011_dataset.csv")
...
boxplot(control$width, treatment$width, names = c("control", "treatment"), ylab = "stomatal opening (microns)")
