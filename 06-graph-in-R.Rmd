...
You can address these issues with the plot function. Try using the help function to figure out what to do (refer to chapter 8 "Getting help in R" to recall how to use help files)
